...
Каждый голосующий выбирает четыре игры, которые ему больше всего понравились, без указания предпочтительности. Затем игры сортируются по количеству голосов. Игра, за которую проголосовали больше всего, получает первое место, следующая - второе и так далее.

Если несколько игр имеют одинаковое количество голосов за одно и то же место, то решение о порядке их размещения принимает организатор, либо проводится дополнительное голосование.
